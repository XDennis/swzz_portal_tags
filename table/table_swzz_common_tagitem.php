...
class table_swzz_common_tagitem extends discuz_table
{
	public function __construct() {

		$this->_table = 'swzz_common_tagitem';
		$this->_pk    = '';
	...
	public function count_by_tagid($tagid) {
		return DB::result_first("SELECT count(*) FROM %t WHERE tagid='".intval($tagid)."'", array($this->_table));
	}
}
