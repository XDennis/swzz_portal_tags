...
class table_swzz_common_tag extends discuz_table
{
	public function __construct() {

		$this->_table = 'swzz_common_tag';
		$this->_pk    = 'tagid';
	...
	public function fetch_info($tagid, $tagname) {
		...
		return DB::fetch_first("SELECT tagid,tagname,status FROM %t WHERE $addsql", array($this->_table));
	}
